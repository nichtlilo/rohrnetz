      ...
      <div className="form-card">
        ...
        <div className="form-section">
          ...
          <div className="equipment-grid">
            <div className="form-group">
              <label className="form-label">Kipper/Montage</label>
              <input
                type="text"
                className="form-input"
            ...
            <div className="form-group">
              <label className="form-label">Atlas</label>
              <input
                type="text"
                className="form-input"
                placeholder="Atlas"
        ...
        <div className="form-section">
          ...
          <div className="form-row">
            <div className="form-group">
              <label className="form-label">Material/Beschreibung</label>
              <input
                type="text"
                className="form-input"
                placeholder="Material"
                value={formData.materialBeschreibung}
                onChange={(e) => handleInputChange('materialBeschreibung', e.target.value)}
              />
            </div>

            <div className="form-group">
              <label className="form-label">Menge/Std.</label>
              <input
                type="text"
                className="form-input"
                placeholder="Menge"
                value={formData.mengeStd}
                onChange={(e) => handleInputChange('mengeStd', e.target.value)}
              />
            </div>
          </div>
        </div>
